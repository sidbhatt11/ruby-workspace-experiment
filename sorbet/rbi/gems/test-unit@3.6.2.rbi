...
module Test::Unit
  class << self
    ...
    # @yieldreturn [void]
    #
    # source://test-unit//lib/test/unit.rb#501
    ...
    # @yieldreturn [void]
    #
    # source://test-unit//lib/test/unit.rb#414
    ...
    #
    # source://test-unit//lib/test/unit.rb#328
    ...
    # @return [Boolean]
    #
    # source://test-unit//lib/test/unit.rb#335
    def run?; end

    # @api private
    #
    # source://test-unit//lib/test/unit.rb#506
    def run_at_exit_hooks; end

    # @api private
    #
    # source://test-unit//lib/test/unit.rb#419
...
class Test::Unit::AutoRunner
  ...
  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/autorunner.rb#179
  def debug_on_failure?; end
  ...
  # source://test-unit//lib/test/unit/autorunner.rb#434
  ...
  # source://test-unit//lib/test/unit/autorunner.rb#473
  def load_config(file); end

  # source://test-unit//lib/test/unit/autorunner.rb#201
  def options; end
  ...
  # source://test-unit//lib/test/unit/autorunner.rb#183
  def prepare; end

  # source://test-unit//lib/test/unit/autorunner.rb#189
  def process_args(args = T.unsafe(nil)); end

  # source://test-unit//lib/test/unit/autorunner.rb#452
  def run; end
  ...
  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/autorunner.rb#175
  ...
  # source://test-unit//lib/test/unit/autorunner.rb#571
  def add_location_filter(path, line); end

  # source://test-unit//lib/test/unit/autorunner.rb#562
  def add_test_path(path); end

  # source://test-unit//lib/test/unit/autorunner.rb#521
  def change_work_directory(&block); end

  # source://test-unit//lib/test/unit/autorunner.rb#506
  ...
  # source://test-unit//lib/test/unit/autorunner.rb#516
  def load_global_config; end

  # source://test-unit//lib/test/unit/autorunner.rb#554
...
# source://test-unit//lib/test/unit/autorunner.rb#587
class Test::Unit::AutoRunner::GCStressListener
  # source://test-unit//lib/test/unit/autorunner.rb#588
...
# source://test-unit//lib/test/unit/autorunner.rb#579
